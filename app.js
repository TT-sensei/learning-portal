const items = [
 ...
 {name:'九九マジカル',repo:'magical-kakezan',category:'教材',subject:'算数',grade:'小学生',desc:'九九の学習をゲーム感覚でくり返し練習。',color:'blue'},
 {name:'わり算バトル',repo:'warizanbattle',category:'教材',subject:'算数',grade:'小学生',desc:'筆算の手順を確認しながら取り組める計算ツール。',color:'blue'},
 {name:'約分クラッシュ',repo:'yakubuncrash',category:'教材',subject:'算数',grade:'小学生',desc:'分数の約分をすばやく判断するゲーム。',color:'blue'},
 {name:'約分スラッシュ',repo:'yakubunslash',category:'教材',subject:'算数',grade:'小学生',desc:'約分をゲーム形式で練習するバトルツール。',color:'blue'},
 {name:'百マス計算',repo:'hyakumasu',category:'教材',subject:'算数',grade:'小学生',desc:'計算の正確さと速さを記録しながら挑戦。',color:'blue'},
 {name:'データ活用',repo:'detakatuyou',category:'教材',subject:'算数',grade:'小学生',desc:'表やグラフを読み取り、データから考えるツール。',color:'blue'},
 {name:'時計べんきょう',repo:'tokeibenkyo',category:'教材',subject:'算数',grade:'小学生',desc:'時計の読み方を動かしながら身につける教材。',color:'blue'},
 ...
 {name:'分数・小数計算',repo:'bunsuuseisuukeisan',category:'教材',subject:'算数',grade:'小学生',desc:'分数や小数の計算をくり返し練習できるツール。',color:'blue'},
 {name:'数のしくみ',repo:'kazunosikumi',category:'教材',subject:'算数',grade:'小学生',desc:'数の見方や仕組みを考える算数教材。',color:'blue'},
 {name:'英検5級チャレンジ',repo:'eiken5',category:'教材',subject:'英語',grade:'小学生',desc:'英検5級レベルの英語をクイズ形式で学ぶ教材。',color:'green'},
 {name:'わり算ランド',repo:'warizanland',category:'教材',subject:'算数',grade:'小学生',desc:'わり算に親しみながら練習できる学習ゲーム。',color:'blue'},
